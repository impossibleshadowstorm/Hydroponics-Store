                            ...
                            child: Column(
                              children: [
                                TextFormField(
                                  ...
                                  controller: farmerMainController.updateCropName,
                                  enabled: farmerMainController
                                      .editCropsActivated.value,
                                  textCapitalization:
                                ...
                                TextFormField(
                                  ...
                                  controller: farmerMainController.updateCropCategory,
                                  enabled: farmerMainController
                                      .editCropsActivated.value,
                                  textCapitalization:
                                      TextCapitalization.sentences,
                                ...
                                TextFormField(
                                  ...
                                  controller: farmerMainController.updateCropPrice,
                                  textCapitalization:
                                      TextCapitalization.sentences,
                                  maxLines: 1,
          ...
          Expanded(
            child: Row(
              ...
              children: [
                InkWell(
                  onTap: () {
                    farmerMainController.editCropsActivated.value = true;
                  },
                  child: Container(
                    height: 40,
                    color: ColorConstants.primaryColor,
