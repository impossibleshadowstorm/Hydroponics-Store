...
class _BuyerRegistrationState extends State<BuyerRegistration> {
  BuyerRegistrationFormController buyerRegistrationFormController =
      Get.put(BuyerRegistrationFormController());
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          children: [
                            InkWell(
                              onTap: () {
                                buyerRegistrationFormController
                                    .pickImage(context);
                              },
                              child: Container(
                                height: 100,
                      ...
                      TextFormField(
                        ...
                        controller:
                            buyerRegistrationFormController.buyerFullName,
                        maxLines: 1,
                      ...
                      TextFormField(
                        controller:
                            buyerRegistrationFormController.buyerMobileNumber,
                        style: const TextStyle(
                          letterSpacing: 3,
                        ),
                        enabled: false,
                      ...
                      TextFormField(
                        ...
                        controller: buyerRegistrationFormController
                            .buyerAlternateMobileNumber,
                        maxLines: 1,
                        maxLength: 10,
                      ...
                      TextFormField(
                        ...
                        maxLengthEnforcement: MaxLengthEnforcement.enforced,
                        controller:
                            buyerRegistrationFormController.buyerAadhaarNumber,
                        decoration: const InputDecoration(
                          label: Text(
                            "Aadhaar Number",
                            style: TextStyle(letterSpacing: 1),
                      ...
                      TextFormField(
                        ...
                        controller:
                            buyerRegistrationFormController.buyerTANNumber,
                        maxLines: 1,
                      ...
                      TextFormField(
                        ...
                        controller:
                            buyerRegistrationFormController.buyerGSTNumber,
                        style: const TextStyle(
                          letterSpacing: 3,
                        ),
                        maxLength: 15,
                      ...
                      TextFormField(
                        ...
                        controller: buyerRegistrationFormController.buyerCity,
                        style: const TextStyle(
                          letterSpacing: 3,
                        ),
                        maxLines: 1,
                      ...
                      TextFormField(
                        ...
                        controller: buyerRegistrationFormController.buyerState,
                        style: const TextStyle(
                          letterSpacing: 3,
                        ),
                        maxLines: 1,
          ...
          floatingActionButton: ElevatedButton(
            onPressed: () {
              ...
              if (formKey.currentState!.validate() &&
                  buyerRegistrationFormController.isProfilePicPathSet.value) {
                buyerRegistrationFormController.uploadFile(context);
              } else {
                buyerRegistrationFormController.profileError.value =
            ...
            child: Text(
              buyerRegistrationFormController.saveButton.value,
              style: const TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold,
              ),
