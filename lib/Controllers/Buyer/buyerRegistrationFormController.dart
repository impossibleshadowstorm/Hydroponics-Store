...
class BuyerRegistrationFormController extends GetxController {
  UserModeController userModeController = Get.find();

  TextEditingController buyerFullName = TextEditingController();
  TextEditingController buyerMobileNumber = TextEditingController();
  TextEditingController buyerAlternateMobileNumber = TextEditingController();
  TextEditingController buyerAadhaarNumber = TextEditingController();
  TextEditingController buyerTANNumber = TextEditingController();
  TextEditingController buyerGSTNumber = TextEditingController();
  TextEditingController buyerAddress = TextEditingController();
  TextEditingController buyerCity = TextEditingController();
  TextEditingController buyerState = TextEditingController();
  ...
  Future addDataToFirebase() async {
    await FirebaseFirestore.instance
        ...
        .doc("details")
        .set({
      "fullName": buyerFullName.text,
      "mobileNumber": userModeController.getRightData()["phone"].text,
      "alternateMobileNumber": buyerAlternateMobileNumber.text,
      "aadhaarNumber": buyerAadhaarNumber.text,
      "gstNumber": buyerGSTNumber.text,
      "tanNumber": buyerTANNumber.text,
      "address": buyerAddress.text,
      "city": buyerCity.text,
      "state": buyerState.text,
